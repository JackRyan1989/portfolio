    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "underline svelte-1t8ucli");
    			...
    			attr_dev(button, "class", "svelte-1t8ucli");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(link0, "class", "svelte-1t8ucli");
    			...
    			attr_dev(link1, "class", "svelte-1t8ucli");
    			add_location(link1, file, 8, 2, 187);
    			attr_dev(span, "class", "svelte-1t8ucli");
    			add_location(span, file, 15, 49, 424);
    			attr_dev(h1, "class", h1_class_value = "" + (null_to_empty(/*makeSmall*/ ctx[0] ? "shrink" : "expand") + " svelte-1t8ucli"));
    			add_location(h1, file, 15, 2, 377);
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(/*makeSmall*/ ctx[0] ? "links" : "no-links") + " svelte-1t8ucli"));
    			add_location(div, file, 16, 2, 455);
    			attr_dev(header, "class", header_class_value = "" + (null_to_empty(/*makeSmall*/ ctx[0] ? "shrinko" : "expando") + " svelte-1t8ucli"));
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*makeSmall*/ 1 && h1_class_value !== (h1_class_value = "" + (null_to_empty(/*makeSmall*/ ctx[0] ? "shrink" : "expand") + " svelte-1t8ucli"))) {
    			...
    			if (dirty & /*makeSmall*/ 1 && div_class_value !== (div_class_value = "" + (null_to_empty(/*makeSmall*/ ctx[0] ? "links" : "no-links") + " svelte-1t8ucli"))) {
    				attr_dev(div, "class", div_class_value);
    			}

    			if (dirty & /*makeSmall*/ 1 && header_class_value !== (header_class_value = "" + (null_to_empty(/*makeSmall*/ ctx[0] ? "shrinko" : "expando") + " svelte-1t8ucli"))) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-fohrtz");
    			add_location(h2, file$2, 16, 4, 344);
    			attr_dev(br0, "class", "svelte-fohrtz");
    			add_location(br0, file$2, 17, 4, 364);
    			attr_dev(br1, "class", "svelte-fohrtz");
    			add_location(br1, file$2, 24, 6, 724);
    			attr_dev(br2, "class", "svelte-fohrtz");
    			add_location(br2, file$2, 25, 6, 737);
    			attr_dev(p, "class", "svelte-fohrtz");
    			add_location(p, file$2, 18, 4, 375);
    			attr_dev(div, "class", "svelte-fohrtz");
    			add_location(div, file$2, 31, 6, 1017);
    			attr_dev(article, "class", "svelte-fohrtz");
    			add_location(article, file$2, 15, 2, 330);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(link0, "rel", "preconnect");
    			attr_dev(link0, "href", "https://fonts.gstatic.com");
    			attr_dev(link0, "class", "svelte-fohrtz");
    			add_location(link0, file$2, 6, 2, 102);
    			attr_dev(link1, "href", "https://fonts.googleapis.com/css2?family=Nunito:wght@200;300;400&display=swap");
    			attr_dev(link1, "rel", "stylesheet");
    			attr_dev(link1, "class", "svelte-fohrtz");
    			add_location(link1, file$2, 7, 2, 163);
    			attr_dev(section, "class", "svelte-fohrtz");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			section = element("section");
    			h2 = element("h2");
    			h2.textContent = "Stuff I Done & Made";
    			t2 = space();
    			article = element("article");
    			div = element("div");
